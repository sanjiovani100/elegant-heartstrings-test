export const backgrounds = {
  backgroundImage: {
    ...
    'gradient-secondary': 'linear-gradient(to right, #c1c161, #d4d4b1)',
    'gradient-secondary-hover': 'linear-gradient(to right, #caca6b, #dbdbc0)',
    'gradient-secondary-active': 'linear-gradient(to right, #b8b858, #cdcda2)',
